...
const WordToPdf = () => {
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      setSuccess('Converted to PDF successfully! Downloading...');
  ...
  return (
    <div className="max-w-4xl mx-auto mt-10">
      <div className="text-center mb-8">
        ...
        <p className="text-lg text-gray-600">Make DOC and DOCX files easy to read by converting them to PDF.</p>
      </div>
