  ...
  return (
    <div className="max-w-4xl mx-auto mt-10 px-4">
      <div className="text-center mb-8">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">PDF to Markdown</h1>
        <p className="text-lg text-gray-600 mb-2">Easily turn PDFs into Markdown files. Perfect for notes, docs, and LLMs.</p>
