  ...
  return (
    <div className="max-w-4xl mx-auto mt-10 px-4">
      <div className="text-center mb-8">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">Translate PDF</h1>
        <p className="text-lg text-gray-600 mb-2">Translate your PDF documents into any language while preserving the original layout.</p>
